...
from app.crud import failed_task_crud, task_execution_crud, day_crud, task_crud, manual_day_crud
...
async def list_failed_tasks(session: db_dep, user_id: user_id_dep) -> list[schemas.failed_task.FailedTaskSchema]:
